...
export OSH='/Users/claudiu.roman/.oh-my-bash'
...
# Source column fallback function
[ -f ~/.config/scripts/column-fallback.sh ] && source ~/.config/scripts/column-fallback.sh
# Source git-functions utilities
[ -f ~/.config/scripts/git-functions.sh ] && source ~/.config/scripts/git-functions.sh
# Source system-utils utilities
[ -f ~/.config/scripts/system-utils.sh ] && source ~/.config/scripts/system-utils.sh
# Source file-utils utilities
[ -f ~/.config/scripts/file-utils.sh ] && source ~/.config/scripts/file-utils.sh
